...
# 描画モード
# mode = input('surface (0), z-axis (1) or line-of-sight (2) >>> ')
...
for i in range(len(enlist)):
    filepath0 = '/Users/satoshin/Library/Mobile Documents/com~apple~CloudDocs/PPARC/gc203g_' + \
        str(int(enlist[i]))+'ev_omgR2_1_20220119.txt'
...
print('======')
print('H_trailing ave.: ', np.average(H_trailing))
print('H_leading ave.: ', np.average(H_leading))
...
print('======')
print('H_southhemi ave.: ', np.average(H_southhemi))
print('H_northhemi ave.: ', np.average(H_northhemi))
...
H_south30 = H[-8:, :]
print('======')
print('H_south30 ave.: ', np.average(H_south30))
print('H_north30 ave.: ', np.average(H_north30))
...
print('======')
print('H_trail_south ave.: ', np.average(H_trail_south30))
print('H_trail_north ave.: ', np.average(H_trail_north30))
